    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionalStacks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StackBio = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaUpload", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaUpload_Post_PostId",
                        column: x => x.PostId,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProfessionalStackId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProfessionalStackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPost_AppUserId",
                table: "JobPost",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaUpload_PostId",
                table: "MediaUpload",
                column: "PostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_ProfessionalStackId",
                table: "WorkExperiences",
