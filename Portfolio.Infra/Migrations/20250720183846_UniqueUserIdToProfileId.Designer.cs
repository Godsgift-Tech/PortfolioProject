...
namespace Portfolio.Infra.Migrations
{
    ...
    [Migration("20250720183846_UniqueUserIdToProfileId")]
    partial class UniqueUserIdToProfileId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.WorkExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portfolio.Core.ProfileUser.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Portfolio.Core.ProfileUser.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.ProfessionalStack", b =>
                {
                    b.HasOne("Portfolio.Core.ProfileUser.AppUser", "AppUser")
                        ...
                        .HasForeignKey("Portfolio.Core.Entities.ProfessionalStack", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Portfolio.Core.Entities.WorkExperience", b =>
                {
                    ...
                    b.HasOne("Portfolio.Core.Entities.ProfessionalStack", null)
                        .WithMany("WorkExperiences")
